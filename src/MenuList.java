        ...
        while(screenMenu == true) {
            ...
            switch (menuChoice) {
                case 1:
                    ...
                    System.out.println("enter session month (ex. august, june, or july");
        ...
        while(screenMenu == true) {
            ...
            switch (menuChoice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Enter tribe to display (a-d or z to view all campers" +
                            " in tribes): ");

                    tribe = scanner.next().toLowerCase().charAt(0);
